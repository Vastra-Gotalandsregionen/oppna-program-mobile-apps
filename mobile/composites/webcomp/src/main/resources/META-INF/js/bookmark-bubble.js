...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'Installera denna web app på din telefon: ' +
        'klicka på  pilen och sedan <b>\'Add to Home Screen\'</b>';
  } else {
    bubbleInner.innerHTML = 'Installera denna web app på din telefon: ' +
        'klicka på <b style="font-size:15px">+</b> och sedan ' +
